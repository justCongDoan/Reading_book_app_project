...
public class BookUserFragment extends Fragment {
    ...
    private PdfUserAdapter adapterPdfUser;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //search
        binding.searchET2ID.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    private void loadAllBooks() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterPdfUser = new PdfUserAdapter(getContext(), pdfArrayList);
                //set adapter to recyclerview
                binding.bookRVID.setAdapter(adapterPdfUser);
            }
